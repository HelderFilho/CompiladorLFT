...
public final class AExpMaiorIgualExpLogica extends PExpLogica
{
    private PExp _left_;
    private PExp _right_;

    public AExpMaiorIgualExpLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpMaiorIgualExpLogica(
    ...
    {
        ((Analysis) sw).caseAExpMaiorIgualExpLogica(this);
    }
