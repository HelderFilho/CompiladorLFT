...
public final class AAvalieExpSenaoComando extends PComando
{
    ...
    public Object clone()
    {
        return new AAvalieExpSenaoComando(
    ...
    {
        ((Analysis) sw).caseAAvalieExpSenaoComando(this);
    }
