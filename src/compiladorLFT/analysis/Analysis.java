...
public interface Analysis extends Switch
{
    ...
    void caseAVarRepeat(AVarRepeat node);
    void caseATesteComando(ATesteComando node);
    ...
    void caseAComandoRepeat(AComandoRepeat node);
    void caseAValors(AValors node);
    ...
    void caseACaracterTipo(ACaracterTipo node);
    void caseAIdentificadorVar(AIdentificadorVar node);
    void caseAStringVar(AStringVar node);
    void caseAIdentificadors(AIdentificadors node);
    void caseAStringValor(AStringValor node);
    void caseANumeroIntValor(ANumeroIntValor node);
