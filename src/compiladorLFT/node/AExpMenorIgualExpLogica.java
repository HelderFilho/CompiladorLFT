...
public final class AExpMenorIgualExpLogica extends PExpLogica
{
    private PExp _left_;
    private PExp _right_;

    public AExpMenorIgualExpLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpMenorIgualExpLogica(
    ...
    {
        ((Analysis) sw).caseAExpMenorIgualExpLogica(this);
    }
