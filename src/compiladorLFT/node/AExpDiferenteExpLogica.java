...
public final class AExpDiferenteExpLogica extends PExpLogica
{
    private PExp _left_;
    private PExp _right_;

    public AExpDiferenteExpLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpDiferenteExpLogica(
    ...
    {
        ((Analysis) sw).caseAExpDiferenteExpLogica(this);
    }
